...
{ 
    ...
    public enum WarmerPlateStatus { WARMER_EMPTY = 0, POT_EMPTY, POT_NOT_EMPTY };
    public enum BoilerStatus { EMPTY = 0, NOT_EMPTY };
    public enum BrewButtonStatus { NOT_PUSHED = 0, PUSHED };
    public enum BoilerState { OFF = 0, ON };
    public enum WarmerState { OFF = 0, ON };
    public enum IndicatorState { OFF = 0, ON };
    public enum ReliefValveState { OPEN = 0, CLOSED };
}